...
public record ClienteRecordDto(@NotBlank String nome, @NotBlank String cpf, LocalDate dataNascimento, @NotBlank String senha, @NotNull boolean ativo, @NotNull EmailModel email, @NotNull GeneroModel genero, @NotNull
